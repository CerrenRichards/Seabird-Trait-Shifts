...
# Gather
means2 <- means %>% gather(value = "Mean", key = "Trait", `Generation Length`:`Ground Forager`)
stdev2 <- stdev %>% gather(value = "SD", key = "Trait", `Generation Length`:`Ground Forager`)
...
## Assign Levels to the data to order the plot
