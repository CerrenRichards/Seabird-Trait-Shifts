...
means <- CWM_shift %>% group_by(ocean) %>% summarise(GL_mean = mean(GL_diff, na.rm = T),
                                                     GL_sd = sd(GL_diff, na.rm = T),
                                                     clutch_mean = mean(clutch_diff, na.rm = T),
                                                     clutch_sd = sd(clutch_diff, na.rm = T),
                                                     bm_mean = mean(bm_diff, na.rm = T),
                                                     bm_sd = sd(bm_diff, na.rm = T))
